package com.github.NIThree.AquariumLauncher.ui.panels.partials;
...
public class TopBar extends Panel {
    ...
    public void init(PanelManager panelManager) {
        ...
        imageView.setImage(new Image("images/icon_16x16.png"));
        ...
        // TopBar: center
        Label title = new Label("Aquarium Launcher");
